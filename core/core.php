...
function is_home_page(){
  ...
  if($_SESSION['current_url'] == BASE_PATH || $_SESSION['current_url'] == BASE_PATH.'/index.php/home'){
    return true;
	} else { return false; } 
...
function log_in_to_comment(){
	 ...
	 or <a href='".BASE_PATH."index.php/register&redirect_to=".$_SESSION['current_url']."'>Signup </a> to comment .</p>";
	}
